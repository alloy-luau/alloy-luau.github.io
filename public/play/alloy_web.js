 ...
 * @returns {string}
 */
export function complete(offset) {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.complete(retptr, offset);
 ...
 * @param {number} check_offset
 * @returns {boolean}
 */
export function generated_at(check_offset) {
    const ret = wasm.generated_at(check_offset);
    return ret !== 0;
}
 ...
 * @returns {string}
 */
export function hover(offset) {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.hover(retptr, offset);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export function set_source(source) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.set_source(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
 ...
 * @returns {number}
 */
export function to_check(source_offset) {
    const ret = wasm.to_check(source_offset);
    return ret;
}
 ...
 * @returns {number}
 */
export function to_source(check_offset) {
    const ret = wasm.to_source(check_offset);
    return ret >>> 0;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('alloy_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
